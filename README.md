...
In this assignment, you'll create a computer game called Psychic. These app will run in the browser, and feature dynamically updated HTML and CSS powered by your JavaScript code.
